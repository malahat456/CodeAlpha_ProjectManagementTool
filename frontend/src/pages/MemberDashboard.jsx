...
export default function MemberDashboard() {
  ...
  return (
    <div className="min-h-full w-full p-10 bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      ...
      {/* Quick Tips */}
      <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-6 border border-white/20 shadow-2xl max-w-4xl mx-auto mt-12">
        ...
        <ul className="text-white/80 list-disc pl-5 space-y-2">
          <li>
            Check your assigned projects regularly.
          </li>

          <li>
            Update task status once completed.
          </li>
